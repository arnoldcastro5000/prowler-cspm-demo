...
const RAW_URL = 'https://raw.githubusercontent.com/arnoldcastro5000/prowler-cspm-demo/main/docs/threat-model.md'
...
export default function ThreatModel() {
  ...
  useEffect(() => {
    fetch(RAW_URL)
      ...
      .then(setContent)
      .catch(() => setError('Failed to load threat model document.'))
