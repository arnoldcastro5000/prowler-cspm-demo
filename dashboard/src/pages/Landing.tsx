            ...
            <table className="w-full text-sm table-fixed">
              ...
              <tbody className="divide-y divide-gray-800">
                {([
                  ...
                  ['CI/CD', 'GitHub Actions + Dependabot + Socket.dev', '14 automated checks block unsafe code before it ships + daily dependency reviews'],
            ...
            <table className="w-full text-sm table-fixed">
              ...
              <tbody className="divide-y divide-gray-800">
                {([
                  ...
                  ['Secret Scan (Betterleaks)', 'secret-scan.yml', 'Scans every commit and the full git history for leaked credentials, API keys, and tokens', <>Secret Scan (<a href="https://github.com/betterleaks/betterleaks" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline hover:text-blue-300">Betterleaks</a>)</>],
                  ['Secret Scan (Gitleaks)', null, 'Pre-commit hook — catches leaked credentials, API keys, and tokens before they leave the developer\'s machine', <>Secret Scan (<a href="https://github.com/gitleaks/gitleaks" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline hover:text-blue-300">Gitleaks</a>)</>],
                  ...
                  <tr key={name} className="bg-gray-950">
                    ...
                    <td className="px-4 py-2">
                      {file ? (
                        ...
                        <span className="text-xs text-green-400 font-medium">Active · Pre-commit</span>
                      ) : (
