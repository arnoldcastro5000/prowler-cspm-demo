            ...
            <table className="w-full text-sm table-fixed">
              ...
              <tbody className="divide-y divide-gray-800">
                {([
                  ...
                  ['Secret Scan (Gitleaks)', 'secret-scan.yml', 'Pre-commit hook — catches leaked credentials, API keys, and tokens before they leave the developer\'s machine', <>Secret Scan (<a href="https://github.com/gitleaks/gitleaks" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline hover:text-blue-300">Gitleaks</a>)</>],
