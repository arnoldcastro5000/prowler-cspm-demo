            ...
            <table className="w-full text-sm table-fixed">
              ...
              <tbody className="divide-y divide-gray-800">
                {([
                  ...
                  ['Secret Scan (Betterleaks)', 'secret-scan.yml', 'Scans every commit and the full git history for leaked credentials, API keys, and tokens — successor to Gitleaks with higher detection recall and faster scanning', <>Secret Scan (<a href="https://github.com/betterleaks/betterleaks" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline hover:text-blue-300">Betterleaks</a>)</>],
